...
open class GANormalizeDatePickerView: UIView {
    ...
    typealias DatePickerViewClickedHandler = (_ dateString: String, _ type: GANormalizeDatePickerViewType) -> ()
    ...
    @IBAction func cancleAction(_ sender: UIButton) {
        datePickerViewClickedHandler?("", .cancle)
    }
    
    @IBAction func confirmAction(_ sender: UIButton) {
       datePickerViewClickedHandler?(dateString(), .confirm)
    }
