...
class YYAlertViewController: UIViewController {
    ...
    var toastView: UIView = {
        let v = UIView(frame: CGRect(origin: CGPoint.zero, size: CGSize.zero))
    ...
    lazy var tableView: UITableView = {
        ...
        t.ga_clipStaticViewRectCorner(.bottomRight, cornerRadius: 10)
    ...
    lazy var headerView: YYAlertSelectedTableViewHeaderView = {
        ...
        headerView.ga_clipStaticViewRectCorner(.topLeft, cornerRadius: 5)
...
extension YYAlertViewController {
    fileprivate func addOrientationNotification() {
        NotificationCenter.default.addObserver(self, selector: #selector(screenChange), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    @objc  
    func screenChange() {
